...
const MiscPassword = () => {
  ...
  const [miscAccount, setMiscAccount] = useState(null);

  const { t } = useContext(AuthContext);
  useEffect(() => {
    getMiscPasswordList(t)
      .then((res) => {
                        ...
                        >
                          ...
                          <OptionsMenu
                            ...
                            options={[
                              ...
                              {
                                text: "Delete",
                                onClick: () => deleteMiscPassword(element?.id),
                              },
                              {
                                text: "Permission",
                                onClick: () =>
                                  setModalOpen({
                                    visible: true,
                                    id: element.id,
                                    type: PERMISSION_FORM_TYPE_ENUMS.MISC_PASSWORD_FORM_TYPE_ENUM,
                                    idToUse: "miscAccountId",
                                  }),
                              },
                            ]}
                            position="absolute"
