...
const NonBankerPassword = () => {
  ...
  const [allPasswordStored, setAllPasswordStored] = useState([]);

  const { t } = useContext(AuthContext);
  useEffect(() => {
    getPasswordStorageList(t)
      .then((res) => {
        setAllPasswordStored(res?.data?.data);
  ...
  return (
    <>
      ...
      {!Boolean(allPasswordStored?.length) ? (
        <>
          <Row height="100vh">
            <div
              style={{
                          ...
                          <OptionsMenu
                            ...
                            options={[
                              ...
                              },
                              {
                                text: "Delete",
                                onClick: () =>
                                  deletePasswordStorage(element?.id),
                              },
                              {
                                text: "Permission",
                                onClick: () =>
                                  setModalOpen({
                                    visible: true,
                                    id: element.id,
                                    type: PERMISSION_FORM_TYPE_ENUMS.PASSWORD_STORAGE_FORM_TYPE_ENUM,
                                    idToUse: "passwordStorageId",
                                  }),
                              },
                            ]}
                            position="absolute"
