...
router.delete("/:id", bankAccount_1.bankAccountController.deleteBankAccount);
router.get("/:id", bankAccount_1.bankAccountController.getBankAccountDetailsById);
router.put("/:id", bankAccount_1.bankAccountController.updateBankAccountDetailsById);
