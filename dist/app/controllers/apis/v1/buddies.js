...
exports.buddyController = {
    getBuddies: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const buddies = yield buddyRepo.find({
            where: { user: { id: user === null || user === void 0 ? void 0 : user.id } }, select: {
                id: true,
        ...
        const invitations = yield invitationRepo.find({ where: { user: { id: user === null || user === void 0 ? void 0 : user.id } }, relations: ['user'] });
    ...
    addBuddy: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const user = yield authRepo.findOne({ where: { id: req.user } });
        var primeBuddyExists = yield buddyRepo.find({ where: { user: { id: user === null || user === void 0 ? void 0 : user.id }, buddyType: "subprime" } });
        console.log(primeBuddyExists);
        var extBuddies = yield buddyRepo.find({ where: { user: { id: user === null || user === void 0 ? void 0 : user.id }, buddy: { id: buddy === null || buddy === void 0 ? void 0 : buddy.id } } });
        var extInvitations = yield invitationRepo.find({ where: { user: { id: user === null || user === void 0 ? void 0 : user.id }, buddy: email } });
        var extNotifications = yield notificationRepo.find({ where: { email: email, type: "buddy" } });
        ...
        notification.data = JSON.stringify({ email: email, relation: relation, type: "buddy", inviterId: req.user, inviterEmail: user === null || user === void 0 ? void 0 : user.email });
    ...
    acceptBuddy: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.body;
            const user = yield authRepo.findOne({ where: { id: req.user } });
            const invitation = yield invitationRepo.findOne({ where: { user: { id: id }, buddy: user === null || user === void 0 ? void 0 : user.email } });
            if (invitation) {
                var newBuddy = new Buddies_1.default();
            ...
            const buddy = yield buddyRepo.findOne({ where: { user: { id: id }, buddy: { id: user === null || user === void 0 ? void 0 : user.id } } });
            if (buddy) {
