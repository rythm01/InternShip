...
exports.fileController = {
    ...
    uploadFile: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const rootFolder = yield FolderRepo.findOne({ where: { name: 'root', user: { id: userProfile.id } } });
            if (!rootFolder) {
    ...
    viewFile: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const file = yield FileRepo.findOne({ where: { id: parseInt(id), user: { id: userProfile.id } } });
            if (!file)
